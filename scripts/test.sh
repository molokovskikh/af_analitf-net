...
nunit-console-x86 /nologo /stoponerror /labels $* ./src/client/test/bin/Debug/AnalitF.Net.Client.Test.dll
...
nunit-console-x86 /nologo /stoponerror /labels $* ./src/service/test/bin/Debug/AnalitF.Net.Service.Test.dll
