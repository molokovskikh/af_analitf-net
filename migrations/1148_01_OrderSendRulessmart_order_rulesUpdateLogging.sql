...
add column UseOrderableOffers tinyint(1) unsigned,
add column NotCheckMinOrder tinyint(1) unsigned,
add column SupplierMinQuantity int(10) unsigned,
add column MinOrderQuantityInPercent int(10) unsigned,
add column IgnoreSupplierInNotPharmacy tinyint(1) unsigned,
add column Loader int(10) unsigned,
...
add column StartLine int(11),
add column CodePage int(11),
add column ServiceFields varchar(255)
;
