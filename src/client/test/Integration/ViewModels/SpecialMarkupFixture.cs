...
namespace AnalitF.Net.Client.Test.Integration.ViewModels
{
	...
	public class SpecialMarkupFixture : ViewModelFixture
	{
		...
		{ // подготовка данных
			...
			AnalitF.Net.Client.Config.Env.Current.Settings = settings;
			AnalitF.Net.Client.Config.Env.Current.Addresses = AddressList.ToList();
      ...
      session.Refresh(waybill);
		...
		public void SpecialMarkup_Offer()
		{
			...
			CatalogOfferViewModel model = new CatalogOfferViewModel(catalog);
			Open(model);
